...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private void setupActionBar() {
        ...
        if (actionBar != null) {
            // Show the Up button in the action bar.getSupportActionBar()
            ...
            */
            ...
            isAutoSyncPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ((boolean) newValue) {
                        syncFreqPref.setEnabled(true);
                        syncFreqPref.setSummary(syncFreqPref.getEntry());
                    } else {
                        syncFreqPref.setSummary("「自動でおとす」がOFFなんだ～");
                    }
                    return true;
                }
            });

            if (!isAutoSyncPref.isChecked()) {
            ...
            syncFreqPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    int index = Arrays.asList(getResources().getStringArray(R.array.pref_sync_freq_values))
                            .indexOf(String.valueOf(newValue));
                    String selected_title = getResources().getStringArray(R.array.pref_sync_freq_titles)[index];
